...
public class SysLogServiceImpl implements SysLogService {
    ...
    public void saveDeptLog(SysDept before, SysDept after) {
        ...
        sysLog.setTargetId(after == null ? before.getId() : after.getId());//新增时 before没有id；删除时 after没有id；避免空指针异常
    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()){
            case LogType.TYPE_DEPT:
                ...
                afterDept.setOperateIp(IpUtil.getLocalIPForCMD());
            ...
            case LogType.TYPE_USER:
                ...
                afterUser.setOperateIp(IpUtil.getLocalIPForCMD());
            ...
            case LogType.TYPE_ACL_MODULE:
                ...
                afterAclModule.setOperateIp(IpUtil.getLocalIPForCMD());
            ...
            case LogType.TYPE_ACL:
                ...
                afterAcl.setOperateIp(IpUtil.getLocalIPForCMD());
            ...
            case LogType.TYPE_ROLE:
                ...
                afterRole.setOperateIp(IpUtil.getLocalIPForCMD());
