...
public class GenEntityTool_Mysql_MybatisSQL {
    public static void main(String[] args) {
        // MYSQL 数据库连接驱动信息
        String databaseName = "eesy";// mysql数据库名称
        String user = "root"; // 数据库连接用户名
        String password = "123456"; // 数据库连接密码
        String tableName = "sys_role"; // 要生成实体类的数据库表名（数据库中表名称）
        String entityName = "SysRole";// 要生成实体类的表名 【Java类名】
        String driverClassName = "com.mysql.cj.jdbc.Driver";
        String url = "jdbc:mysql://localhost:3306/" + databaseName + "?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8&allowPublicKeyRetrieval=true";// //
